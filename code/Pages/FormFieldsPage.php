...
class FormFieldsPage_Controller extends Page_Controller
{
    ...
    {
        $optionsArray = array('a' => 'Option 1', 'b' => 'Option 2');
        $fields = array(
            CheckboxField::create('CheckboxField', 'Checkbox Field'),
            CheckboxSetField::create('CheckboxSetField', 'Checkbox Set Field', $optionsArray),
            ...
            DropdownField::create('DropdownField', 'Dropdown Field', $optionsArray),
            EmailField::create('EmailField', 'Email Field'),
            FileField::create('FileField', 'File Field'),
            GroupedDropdownField::create('GroupedDropdownField', 'Grouped Dropdown Field', $optionsArray),
            ...
            ListboxField::create('ListboxField', 'Listbox Field', $optionsArray),
            LiteralField::create('LiteralField', 'This is a literal field'),
            LookupField::create('LookupField', 'Lookup Field', $optionsArray),
            MoneyField::create('MoneyField', 'Money Field'),
            NumericField::create('NumericField', 'Numeric Field'),
            OptionsetField::create('OptionsetField', 'Optionset Field', $optionsArray),
            ...
            SelectionGroup::create('SelectionGroup', $optionsArray),
